...
class HashIndirectList {
    private LinkedList<Show>[] table;
    private int size;

    @SuppressWarnings("unchecked")
    public HashIndirectList() {
        this.size = 21;
        this.table = (LinkedList<Show>[]) new LinkedList[size];
...
public class Main {
  ...
  public static void main(String[] args) throws FileNotFoundException {
    ...
    HashIndirectList hashTable = new HashIndirectList();
    String line;
